...
CREATE ROLE proptech_app WITH LOGIN PASSWORD :'DB_PASSWORD' NOSUPERUSER NOCREATEDB NOCREATEROLE NOINHERIT CONNECTION LIMIT 10;
CREATE ROLE proptech_app_readonly WITH LOGIN PASSWORD :'DB_PASSWORD' NOSUPERUSER NOCREATEDB NOCREATEROLE NOINHERIT CONNECTION LIMIT 5;
CREATE ROLE audit_app WITH LOGIN PASSWORD :'DB_PASSWORD' NOSUPERUSER NOCREATEDB NOCREATEROLE NOINHERIT CONNECTION LIMIT 5;
CREATE ROLE vault_app WITH LOGIN PASSWORD :'DB_PASSWORD' NOSUPERUSER NOCREATEDB NOCREATEROLE NOINHERIT CONNECTION LIMIT 5;
CREATE ROLE quartz_app WITH LOGIN PASSWORD :'DB_PASSWORD' NOSUPERUSER NOCREATEDB NOCREATEROLE NOINHERIT CONNECTION LIMIT 5;
...
ALTER ROLE audit_app SET statement_timeout = '5min';
ALTER ROLE audit_app SET idle_in_transaction_session_timeout = '5min';
ALTER ROLE audit_app SET log_statement = 'ddl';
ALTER ROLE audit_app SET search_path = core, public;

ALTER ROLE vault_app SET statement_timeout = '5min';
ALTER ROLE vault_app SET idle_in_transaction_session_timeout = '5min';
ALTER ROLE vault_app SET log_statement = 'ddl';
ALTER ROLE vault_app SET search_path = core, public;

ALTER ROLE quartz_app SET statement_timeout = '5min';
ALTER ROLE quartz_app SET idle_in_transaction_session_timeout = '5min';
ALTER ROLE quartz_app SET log_statement = 'ddl';
ALTER ROLE quartz_app SET search_path = core, public;
