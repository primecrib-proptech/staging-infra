...
CREATE ROLE proptech_app WITH LOGIN PASSWORD 'SECURE_PASSWORD' NOSUPERUSER NOCREATEDB NOCREATEROLE NOINHERIT CONNECTION LIMIT 10;
CREATE ROLE proptech_app_readonly WITH LOGIN PASSWORD 'READONLY_SECURE_PASSWORD' NOSUPERUSER NOCREATEDB NOCREATEROLE NOINHERIT CONNECTION LIMIT 5;
CREATE ROLE audit_app WITH LOGIN PASSWORD 'AUDIT_SECURE_PASSWORD' NOSUPERUSER NOCREATEDB NOCREATEROLE NOINHERIT CONNECTION LIMIT 5;
CREATE ROLE vault_app WITH LOGIN PASSWORD 'VAULT_SECURE_PASSWORD' NOSUPERUSER NOCREATEDB NOCREATEROLE NOINHERIT CONNECTION LIMIT 5;
CREATE ROLE quartz_app WITH LOGIN PASSWORD 'QUARTZ_SECURE_PASSWORD' NOSUPERUSER NOCREATEDB NOCREATEROLE NOINHERIT CONNECTION LIMIT 5;
